...
Purpose: Enables `/are:init --integration` to generate appropriate command files for any detected AI coding assistant (Claude Code, OpenCode, etc.)
...
3. `IntegrationTemplate` interface:
   ...
   - `path: string` (relative path like '.claude/commands/are/generate.md')
