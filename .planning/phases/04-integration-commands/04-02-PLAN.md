...
Purpose: Users can run `ar init --integration` to set up command files for their AI coding assistant, enabling /ar:generate and /ar:update slash commands.
...
3. For Claude hook:
   - Write hook file to `.claude/hooks/ar-session-end.js`
