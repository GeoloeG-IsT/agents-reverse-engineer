...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/generation/writers/agents-md.ts"
      provides: "AGENTS.md generator"
      exports: ["writeAgentsMd", "DirectoryDoc", "buildAgentsMd"]
...
```
  ...
  <done>AGENTS.md writer exports writeAgentsMd, buildAgentsMd, buildDirectoryDoc, DirectoryDoc type</done>
</task>
...
- [ ] src/generation/writers/agents-md.ts exports writeAgentsMd, buildAgentsMd, DirectoryDoc
