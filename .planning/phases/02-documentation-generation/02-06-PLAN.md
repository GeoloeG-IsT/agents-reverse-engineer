...
export class GenerationOrchestrator {
  ...
  async createPlan(discoveryResult: DiscoveryResult): Promise<GenerationPlan> {
    ...
    const { tasks, skipped } = this.createTasks(files);
...
```
  ...
  <done>Orchestrator exports GenerationOrchestrator, createOrchestrator, GenerationPlan, PreparedFile, AnalysisTask</done>
</task>
